...
public class Main
{
    ...
    private static final Marker INVALID_STATIONS_MARKER = MarkerManager.getMarker("INVALID_STATIONS").setParents(EXCEPTIONS_MARKER);
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            LOGGER.info(INPUT_HISTORY_MARKER,"\n" + message + "\n" + line);
            Station station = stationIndex.getStation(line);
            if(station != null) {
                return station;
            }
            LOGGER.error(INVALID_STATIONS_MARKER,"Станция не найдена: " + line);
